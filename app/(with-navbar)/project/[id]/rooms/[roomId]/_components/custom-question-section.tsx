      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <Input
            ...
            className="flex-1"
          />
          <Button className="w-full sm:w-auto" onClick={handleAskQuestion} disabled={isAsking || !question.trim()}>
            {isAsking ? "Asking..." : "Ask"}
          </Button>
        </div>
            ...
            {customQuestions.map((customQ) => (
              <div key={customQ._id} className="border rounded-lg p-4 space-y-3">
                ...
                {customQ.status === "generating" ? (
                  ...
                  <div className="sm:pl-6 text-sm text-destructive">
