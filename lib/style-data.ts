  ...
  options: [
    {
      ...
      imageUrl: "https://images.unsplash.com/photo-1752004028694-72610be3604e?auto=format&fit=crop&q=80&w=800",
    },
    {
      id: "energy",
      label: "Energy & Inspiration",
      description: "Bold colors and creative stimulation",
      imageUrl: "https://images.unsplash.com/photo-1761828122942-e09382131eb1?auto=format&fit=crop&q=80&w=800",
    },
    {
      id: "cozy",
      label: "Cozy & Secure",
      description: "Warmth, comfort, and a lived-in feel",
      imageUrl: "https://images.unsplash.com/photo-1758915753369-6a33c7bc1d76?auto=format&fit=crop&q=80&w=800",
    },
    {
      id: "order",
      label: "Order & Focus",
  ...
  options: [
    {
      ...
      imageUrl: "https://images.unsplash.com/photo-1760941887001-337e56dd8026?auto=format&fit=crop&q=80&w=800",
    },
    {
      id: "traditional",
      label: "Traditional/Classic",
      description: "Timeless, curved arms, and tufted fabrics",
      imageUrl: "https://images.unsplash.com/photo-1507452786732-f2dc0a2e7b7f?auto=format&fit=crop&q=80&w=800",
    },
    {
      id: "bohemian",
      label: "Bohemian/Eclectic",
      description: "Layered textures, patterns, and natural materials",
      imageUrl: "https://images.unsplash.com/photo-1770872938037-390c2f1a987f?auto=format&fit=crop&q=80&w=800",
    },
    {
      id: "industrial",
      label: "Industrial",
      description: "Raw materials like weathered wood and metal pipes",
      imageUrl: "https://images.unsplash.com/photo-1717095858862-1f71e1f099ff?auto=format&fit=crop&q=80&w=800",
    },
  ],
};
  ...
  options: [
    {
      ...
      imageUrl: "https://images.unsplash.com/photo-1761052180945-9fcefc9a07d5?auto=format&fit=crop&q=80&w=800",
    },
    {
      id: "curator",
      label: "The Curator",
      description: "I like a balanced amount of meaningful, styled pieces",
      imageUrl: "https://images.unsplash.com/photo-1718049720099-a035f05e539a?auto=format&fit=crop&q=80&w=800",
    },
    {
      id: "collector",
      label: "The Collector",
      description: "Having many mementos around me makes me feel good",
      imageUrl: "https://images.unsplash.com/photo-1673710033854-76bc19809e05?auto=format&fit=crop&q=80&w=800",
    },
  ],
};
  ...
  options: [
    {
      ...
      imageUrl: "https://images.unsplash.com/photo-1754613389131-ea9b5f234cda?auto=format&fit=crop&q=80&w=800",
    },
    {
      id: "natural",
      label: "Natural & Organic",
      description: "Textures found in nature like wood grain or stone",
      imageUrl: "https://images.unsplash.com/photo-1765273702526-3b480756e96b?auto=format&fit=crop&q=80&w=800",
    },
    {
      id: "bold",
      label: "Bold & Patterned",
      description: "I love geometric prints, stripes, or florals",
      imageUrl: "https://images.unsplash.com/photo-1769758791765-9d4e8cc5a38d?auto=format&fit=crop&q=80&w=800",
    },
  ],
};
